...
const Footer = () => {
  return (
    <>
      <footer className="pt-16 px-12 bg-sky-900 flex justify-between max-sm:flex-col max-sm:gap-10">
        <div className="flex flex-col gap-10">
          ...
          <div className="flex gap-3">
            ...
            <p className="break-words text-sm text-white">okifftuh@gmail.com</p>
          </div>
        </div>
        <div className="flex flex-col gap-10">
          <h3 className="font-bold text-white">UNIT KEGIATAN MAHASISWA</h3>
          <h3 className="font-semibold text-white">- Coder Institute</h3>
